              ...
              <div className="p-2 space-y-1">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          {member.customImageUrl && (
                            <button
                              ...
                              className="p-1 text-lime-500 hover:bg-lime-50 dark:hover:bg-lime-700/20 rounded"
                ...
                {!member.isCaptain && (
                  <button
                    ...
                    className="w-full flex items-center gap-2 px-3 py-2 text-sm text-left text-lime-500 hover:bg-lime-50 dark:hover:bg-lime-700/20 rounded"
                  >
